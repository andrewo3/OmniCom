...
int main(int argc, char ** argv) {
    ...
    command_stream << "-Isrc/ntsc-filter -Iinclude/universal -Isrc/imgui -Isrc/imgui/backends src/imgui/backends/*.cpp src/imgui/*.cpp src/ntsc-filter/crt_core.c src/ntsc-filter/crt_ntsc.c src/*.cpp src/NES/*.cpp src/window/*.cpp -Llib -sUSE_SDL=2 -o web/static/index.js";
