...
.proc MetatileFlags
  ...
  .byt %00000000          ; solid blocks
  .byt %00000000          ; platform (left edge)
  .byt %00000000          ; platform (middle)
  .byt %00000000          ; platform (right edge)
  .byt %00000001          ; solid grass (left)
  .byt %00000001          ; solid grass (middle)
  .byt %00000001          ; solid grass (right)
  .byt %00000001          ; solid grass (tower)
  .byt %00000001          ; solid grass (bottom left)
  .byt %00000001          ; solid grass (bottom middle)
  .byt %00000001          ; solid grass (bottom right)
  .byt %00000001          ; solid grass (bottom tower)
.endproc
